...
Symphony MUST persist workflow state, provider cursors, work item snapshots, repository bindings, pull request bindings, command requests, jobs, and audit records in SQLite for v1.
