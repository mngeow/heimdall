...
**Reason**: The operator-facing service identity is being renamed from Symphony to Heimdall.
**Migration**: Update service-unit, journal, and troubleshooting references to use Heimdall naming.

### Requirement: Symphony exposes health and readiness signals
**Reason**: The service identity exposed to operators is being renamed from Symphony to Heimdall.
**Migration**: Update deployment and operations guidance to refer to Heimdall health and readiness checks.

### Requirement: Symphony records an audit trail for mutation workflows
**Reason**: Audit and operator guidance must consistently identify the renamed service as Heimdall.
**Migration**: Rename audit-trail references and examples to Heimdall while preserving the same recorded fields.
