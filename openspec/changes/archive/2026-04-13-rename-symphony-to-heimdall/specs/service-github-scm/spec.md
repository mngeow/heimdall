...
**Reason**: Managed pull request identity and label examples are being renamed from Symphony to Heimdall.
**Migration**: Reconcile repository label configuration and pull request matching logic against Heimdall-managed pull requests and `heimdall-monitored` label examples.

### Requirement: Symphony mutation commands are limited to Symphony-created pull requests
**Reason**: Mutation-command eligibility is being rebranded from Symphony-managed pull requests to Heimdall-managed pull requests.
**Migration**: Evaluate command eligibility against Heimdall-created or adopted pull requests instead of Symphony-created pull requests.
