...
**Reason**: The behavior-suite identity is being rebranded from Symphony to Heimdall.
**Migration**: Rename behavior-suite references, fixtures, and release-gate language to Heimdall while preserving the same workflow coverage expectations.
