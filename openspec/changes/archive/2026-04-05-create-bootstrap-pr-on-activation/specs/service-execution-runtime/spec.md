...
#### Scenario: Heimdall runs an OpenCode bootstrap step
- **WHEN** Heimdall executes an activation-triggered workflow step through `opencode`, `git`, or GitHub API-backed repository mutation logic
